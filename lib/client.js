window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = ".HORUzq_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.HORUzq_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.HORUzq_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.HORUzq_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.HORUzq_status{color:var(--dsw-alias-label-secondary);font-size:12px;font-weight:400;line-height:18px}.HORUzq_button{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.HORUzq_button:hover{background:var(--dsw-alias-interactive-bg-hover)}";
		...
		var NotificationSettingsRow_module_css_default = {
			"rowText": "HORUzq_rowText",
			"title": "HORUzq_title",
			"desc": "HORUzq_desc",
			"status": "HORUzq_status",
			"button": "HORUzq_button",
			"row": "HORUzq_row"
		};
		//#endregion
